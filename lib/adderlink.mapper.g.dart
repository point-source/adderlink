...
class DeviceMapper extends BaseMapper<p3.Device> {
  ...
  p3.Device fromMap(Map<String, dynamic> map) => p3.Device(deviceId: Mapper.i.$get(map, 'd_id'), serialNumber: Mapper.i.$get(map, 'd_serial_number'), macAddress: Mapper.i.$get(map, 'd_mac_address'), macAddress2: Mapper.i.$get(map, 'd_mac_address2'), name: Mapper.i.$getOpt(map, 'd_name'), online: Mapper.i.$get(map, 'd_online'), online2: Mapper.i.$get(map, 'd_online2'), type: Mapper.i.$get(map, 'd_type'), version: Mapper.i.$get(map, 'd_version'), variant: Mapper.i.$getOpt(map, 'd_variant'), ipAddress0: Mapper.i.$getOpt(map, 'd_ip_address0'), ipAddress: Mapper.i.$getOpt(map, 'd_ip_address'), ipAddress2: Mapper.i.$getOpt(map, 'd_ip_address2'), description: Mapper.i.$getOpt(map, 'd_description'), location: Mapper.i.$getOpt(map, 'd_location'), configured: Mapper.i.$get(map, 'd_configured'), validFirmware: Mapper.i.$get(map, 'd_valid_firmware'), validBackupFirmware: Mapper.i.$get(map, 'd_valid_backup_firmware'), firmware: Mapper.i.$get(map, 'd_firmware'), backupFirmware: Mapper.i.$get(map, 'd_backup_firmware'), dateAdded: Mapper.i.$getOpt(map, 'd_date_added'), status: Mapper.i.$get(map, 'd_status'), domainNumber: Mapper.i.$getOpt(map, 'd_domain_no'), deviceVdiType: Mapper.i.$getOpt(map, 'd_device_vdi_type'), conExclusive: Mapper.i.$getOpt(map, 'con_exclusive'), conControl: Mapper.i.$getOpt(map, 'con_control'), conStartTime: Mapper.i.$getOpt(map, 'con_start_time'), conEndTime: Mapper.i.$getOpt(map, 'con_end_time'), username: Mapper.i.$getOpt(map, 'u_username'), userId: Mapper.i.$getOpt(map, 'u_id'), channelName: Mapper.i.$getOpt(map, 'c_name'), countReceiverGroups: Mapper.i.$getOpt(map, 'count_receiver_groups'), countReceiverPresets: Mapper.i.$getOpt(map, 'count_receiver_presets'), countUsers: Mapper.i.$getOpt(map, 'count_users'));
...
class _DeviceCopyWithImpl<$R> extends BaseCopyWith<$R, p3.Device, p3.Device> implements DeviceCopyWith<$R> {
  ...
  @override $R call({String? deviceId, String? serialNumber, String? macAddress, String? macAddress2, Object? name = $none, String? online, String? online2, String? type, String? version, Object? variant = $none, Object? ipAddress0 = $none, Object? ipAddress = $none, Object? ipAddress2 = $none, Object? description = $none, Object? location = $none, String? configured, String? validFirmware, String? validBackupFirmware, String? firmware, String? backupFirmware, Object? dateAdded = $none, String? status, Object? domainNumber = $none, Object? deviceVdiType = $none, Object? conExclusive = $none, Object? conControl = $none, Object? conStartTime = $none, Object? conEndTime = $none, Object? username = $none, Object? userId = $none, Object? channelName = $none, Object? countReceiverGroups = $none, Object? countReceiverPresets = $none, Object? countUsers = $none}) => $then(p3.Device(deviceId: deviceId ?? $value.deviceId, serialNumber: serialNumber ?? $value.serialNumber, macAddress: macAddress ?? $value.macAddress, macAddress2: macAddress2 ?? $value.macAddress2, name: or(name, $value.name), online: online ?? $value.online, online2: online2 ?? $value.online2, type: type ?? $value.type, version: version ?? $value.version, variant: or(variant, $value.variant), ipAddress0: or(ipAddress0, $value.ipAddress0), ipAddress: or(ipAddress, $value.ipAddress), ipAddress2: or(ipAddress2, $value.ipAddress2), description: or(description, $value.description), location: or(location, $value.location), configured: configured ?? $value.configured, validFirmware: validFirmware ?? $value.validFirmware, validBackupFirmware: validBackupFirmware ?? $value.validBackupFirmware, firmware: firmware ?? $value.firmware, backupFirmware: backupFirmware ?? $value.backupFirmware, dateAdded: or(dateAdded, $value.dateAdded), status: status ?? $value.status, domainNumber: or(domainNumber, $value.domainNumber), deviceVdiType: or(deviceVdiType, $value.deviceVdiType), conExclusive: or(conExclusive, $value.conExclusive), conControl: or(conControl, $value.conControl), conStartTime: or(conStartTime, $value.conStartTime), conEndTime: or(conEndTime, $value.conEndTime), username: or(username, $value.username), userId: or(userId, $value.userId), channelName: or(channelName, $value.channelName), countReceiverGroups: or(countReceiverGroups, $value.countReceiverGroups), countReceiverPresets: or(countReceiverPresets, $value.countReceiverPresets), countUsers: or(countUsers, $value.countUsers)));
}
