...
import 'src/models/body/get_channels.dart' as p3;
import 'src/models/body/get_devices.dart' as p5;
import 'src/models/body/login.dart' as p4;
...
class GetChannelsBodyMapper extends BaseMapper<p3.GetChannelsBody> {
  GetChannelsBodyMapper._();

  @override Function get decoder => decode;
  p3.GetChannelsBody decode(dynamic v) => checked(v, (Map<String, dynamic> map) => fromMap(map));
  p3.GetChannelsBody fromMap(Map<String, dynamic> map) => p3.GetChannelsBody(page: Mapper.i.$get(map, 'page'), resultsPerPage: Mapper.i.$get(map, 'results_per_page'), channelCount: Mapper.i.$get(map, 'count_channels'), channels: Mapper.i.$get(map, 'channels'));

  @override Function get encoder => encode;
  dynamic encode(p3.GetChannelsBody v) => toMap(v);
  Map<String, dynamic> toMap(p3.GetChannelsBody g) => {'page': Mapper.i.$enc(g.page, 'page'), 'results_per_page': Mapper.i.$enc(g.resultsPerPage, 'resultsPerPage'), 'count_channels': Mapper.i.$enc(g.channelCount, 'channelCount'), 'channels': Mapper.i.$enc(g.channels, 'channels')};

  @override String stringify(p3.GetChannelsBody self) => 'GetChannelsBody(page: ${Mapper.asString(self.page)}, resultsPerPage: ${Mapper.asString(self.resultsPerPage)}, channelCount: ${Mapper.asString(self.channelCount)}, channels: ${Mapper.asString(self.channels)})';
  @override int hash(p3.GetChannelsBody self) => Mapper.hash(self.page) ^ Mapper.hash(self.resultsPerPage) ^ Mapper.hash(self.channelCount) ^ Mapper.hash(self.channels);
  @override bool equals(p3.GetChannelsBody self, p3.GetChannelsBody other) => Mapper.isEqual(self.page, other.page) && Mapper.isEqual(self.resultsPerPage, other.resultsPerPage) && Mapper.isEqual(self.channelCount, other.channelCount) && Mapper.isEqual(self.channels, other.channels);

  @override Function get typeFactory => (f) => f<p3.GetChannelsBody>();
}

mixin GetChannelsBodyMappable implements MappableMixin {
  String toJson() => Mapper.toJson(this as p3.GetChannelsBody);
  Map<String, dynamic> toMap() => Mapper.toMap(this as p3.GetChannelsBody);
  GetChannelsBodyCopyWith<p3.GetChannelsBody> get copyWith => _GetChannelsBodyCopyWithImpl(this as p3.GetChannelsBody, $identity, $identity);
  @override String toString() => Mapper.asString(this);
  @override bool operator ==(Object other) => identical(this, other) || (runtimeType == other.runtimeType && Mapper.isEqual(this, other));
  @override int get hashCode => Mapper.hash(this);
}

extension GetChannelsBodyObjectCopy<$R> on ObjectCopyWith<$R, p3.GetChannelsBody, p3.GetChannelsBody> {
  GetChannelsBodyCopyWith<$R> get asGetChannelsBody => base.as((v, t, t2) => _GetChannelsBodyCopyWithImpl(v, t, t2));
}

abstract class GetChannelsBodyCopyWith<$R> implements ObjectCopyWith<$R, p3.GetChannelsBody, p3.GetChannelsBody> {
  GetChannelsBodyCopyWith<$R2> _chain<$R2>(Then<p3.GetChannelsBody, p3.GetChannelsBody> t, Then<p3.GetChannelsBody, $R2> t2);
  ChannelsCopyWith<$R> get channels;
  $R call({String? page, String? resultsPerPage, String? channelCount, p3.Channels? channels});
}

class _GetChannelsBodyCopyWithImpl<$R> extends BaseCopyWith<$R, p3.GetChannelsBody, p3.GetChannelsBody> implements GetChannelsBodyCopyWith<$R> {
  _GetChannelsBodyCopyWithImpl(super.value, super.then, super.then2);
  @override GetChannelsBodyCopyWith<$R2> _chain<$R2>(Then<p3.GetChannelsBody, p3.GetChannelsBody> t, Then<p3.GetChannelsBody, $R2> t2) => _GetChannelsBodyCopyWithImpl($value, t, t2);

  @override ChannelsCopyWith<$R> get channels => $value.channels.copyWith._chain($identity, (v) => call(channels: v));
  @override $R call({String? page, String? resultsPerPage, String? channelCount, p3.Channels? channels}) => $then(p3.GetChannelsBody(page: page ?? $value.page, resultsPerPage: resultsPerPage ?? $value.resultsPerPage, channelCount: channelCount ?? $value.channelCount, channels: channels ?? $value.channels));
}

class ChannelsMapper extends BaseMapper<p3.Channels> {
  ChannelsMapper._();

  @override Function get decoder => decode;
  p3.Channels decode(dynamic v) => checked(v, (Map<String, dynamic> map) => fromMap(map));
  p3.Channels fromMap(Map<String, dynamic> map) => p3.Channels(channel: Mapper.i.$get(map, 'channel'));

  @override Function get encoder => encode;
  dynamic encode(p3.Channels v) => toMap(v);
  Map<String, dynamic> toMap(p3.Channels c) => {'channel': Mapper.i.$enc(c.channel, 'channel')};

  @override String stringify(p3.Channels self) => 'Channels(channel: ${Mapper.asString(self.channel)})';
  @override int hash(p3.Channels self) => Mapper.hash(self.channel);
  @override bool equals(p3.Channels self, p3.Channels other) => Mapper.isEqual(self.channel, other.channel);

  @override Function get typeFactory => (f) => f<p3.Channels>();
}

mixin ChannelsMappable implements MappableMixin {
  String toJson() => Mapper.toJson(this as p3.Channels);
  Map<String, dynamic> toMap() => Mapper.toMap(this as p3.Channels);
  ChannelsCopyWith<p3.Channels> get copyWith => _ChannelsCopyWithImpl(this as p3.Channels, $identity, $identity);
  @override String toString() => Mapper.asString(this);
  @override bool operator ==(Object other) => identical(this, other) || (runtimeType == other.runtimeType && Mapper.isEqual(this, other));
  @override int get hashCode => Mapper.hash(this);
}

extension ChannelsObjectCopy<$R> on ObjectCopyWith<$R, p3.Channels, p3.Channels> {
  ChannelsCopyWith<$R> get asChannels => base.as((v, t, t2) => _ChannelsCopyWithImpl(v, t, t2));
}

abstract class ChannelsCopyWith<$R> implements ObjectCopyWith<$R, p3.Channels, p3.Channels> {
  ChannelsCopyWith<$R2> _chain<$R2>(Then<p3.Channels, p3.Channels> t, Then<p3.Channels, $R2> t2);
  ListCopyWith<$R, p3.Channel, ChannelCopyWith<$R>> get channel;
  $R call({List<p3.Channel>? channel});
}

class _ChannelsCopyWithImpl<$R> extends BaseCopyWith<$R, p3.Channels, p3.Channels> implements ChannelsCopyWith<$R> {
  _ChannelsCopyWithImpl(super.value, super.then, super.then2);
  @override ChannelsCopyWith<$R2> _chain<$R2>(Then<p3.Channels, p3.Channels> t, Then<p3.Channels, $R2> t2) => _ChannelsCopyWithImpl($value, t, t2);

  @override ListCopyWith<$R, p3.Channel, ChannelCopyWith<$R>> get channel => ListCopyWith($value.channel, (v, t) => v.copyWith._chain($identity, t), (v) => call(channel: v));
  @override $R call({List<p3.Channel>? channel}) => $then(p3.Channels(channel: channel ?? $value.channel));
}

class ChannelMapper extends BaseMapper<p3.Channel> {
  ChannelMapper._();

  @override Function get decoder => decode;
  p3.Channel decode(dynamic v) => checked(v, (Map<String, dynamic> map) => fromMap(map));
  p3.Channel fromMap(Map<String, dynamic> map) => p3.Channel(channelId: Mapper.i.$get(map, 'c_id'), name: Mapper.i.$getOpt(map, 'c_name'), description: Mapper.i.$getOpt(map, 'c_description'), location: Mapper.i.$getOpt(map, 'c_location'), channelType: Mapper.i.$get(map, 'c_channel_type'), transmitterId: Mapper.i.$get(map, 'c_tx_id'), favourite: Mapper.i.$get(map, 'c_favourite'), online: Mapper.i.$get(map, 'channel_online'), video1: Mapper.i.$getOpt(map, 'c_video1'), video1Head: Mapper.i.$getOpt(map, 'c_video1_head'), video2: Mapper.i.$getOpt(map, 'c_video2'), video2Head: Mapper.i.$getOpt(map, 'c_video2_head'), audio: Mapper.i.$getOpt(map, 'c_audio'), usb: Mapper.i.$getOpt(map, 'c_usb'), usb1: Mapper.i.$getOpt(map, 'c_usb1'), serial: Mapper.i.$getOpt(map, 'c_serial'), audio1: Mapper.i.$getOpt(map, 'c_audio1'), audio2: Mapper.i.$getOpt(map, 'c_audio2'), sensitive: Mapper.i.$get(map, 'c_sensitive'), viewButton: Mapper.i.$get(map, 'view_button'), sharedButton: Mapper.i.$get(map, 'shared_button'), controlButton: Mapper.i.$get(map, 'control_button'), exclusiveButton: Mapper.i.$get(map, 'exclusive_button'));

  @override Function get encoder => encode;
  dynamic encode(p3.Channel v) => toMap(v);
  Map<String, dynamic> toMap(p3.Channel c) => {'c_id': Mapper.i.$enc(c.channelId, 'channelId'), 'c_name': Mapper.i.$enc(c.name, 'name'), 'c_description': Mapper.i.$enc(c.description, 'description'), 'c_location': Mapper.i.$enc(c.location, 'location'), 'c_channel_type': Mapper.i.$enc(c.channelType, 'channelType'), 'c_tx_id': Mapper.i.$enc(c.transmitterId, 'transmitterId'), 'c_favourite': Mapper.i.$enc(c.favourite, 'favourite'), 'channel_online': Mapper.i.$enc(c.online, 'online'), 'c_video1': Mapper.i.$enc(c.video1, 'video1'), 'c_video1_head': Mapper.i.$enc(c.video1Head, 'video1Head'), 'c_video2': Mapper.i.$enc(c.video2, 'video2'), 'c_video2_head': Mapper.i.$enc(c.video2Head, 'video2Head'), 'c_audio': Mapper.i.$enc(c.audio, 'audio'), 'c_usb': Mapper.i.$enc(c.usb, 'usb'), 'c_usb1': Mapper.i.$enc(c.usb1, 'usb1'), 'c_serial': Mapper.i.$enc(c.serial, 'serial'), 'c_audio1': Mapper.i.$enc(c.audio1, 'audio1'), 'c_audio2': Mapper.i.$enc(c.audio2, 'audio2'), 'c_sensitive': Mapper.i.$enc(c.sensitive, 'sensitive'), 'view_button': Mapper.i.$enc(c.viewButton, 'viewButton'), 'shared_button': Mapper.i.$enc(c.sharedButton, 'sharedButton'), 'control_button': Mapper.i.$enc(c.controlButton, 'controlButton'), 'exclusive_button': Mapper.i.$enc(c.exclusiveButton, 'exclusiveButton')};

  @override String stringify(p3.Channel self) => 'Channel(channelId: ${Mapper.asString(self.channelId)}, name: ${Mapper.asString(self.name)}, description: ${Mapper.asString(self.description)}, location: ${Mapper.asString(self.location)}, channelType: ${Mapper.asString(self.channelType)}, transmitterId: ${Mapper.asString(self.transmitterId)}, favourite: ${Mapper.asString(self.favourite)}, online: ${Mapper.asString(self.online)}, video1: ${Mapper.asString(self.video1)}, video1Head: ${Mapper.asString(self.video1Head)}, video2: ${Mapper.asString(self.video2)}, video2Head: ${Mapper.asString(self.video2Head)}, audio: ${Mapper.asString(self.audio)}, usb: ${Mapper.asString(self.usb)}, usb1: ${Mapper.asString(self.usb1)}, serial: ${Mapper.asString(self.serial)}, audio1: ${Mapper.asString(self.audio1)}, audio2: ${Mapper.asString(self.audio2)}, sensitive: ${Mapper.asString(self.sensitive)}, viewButton: ${Mapper.asString(self.viewButton)}, sharedButton: ${Mapper.asString(self.sharedButton)}, controlButton: ${Mapper.asString(self.controlButton)}, exclusiveButton: ${Mapper.asString(self.exclusiveButton)})';
  @override int hash(p3.Channel self) => Mapper.hash(self.channelId) ^ Mapper.hash(self.name) ^ Mapper.hash(self.description) ^ Mapper.hash(self.location) ^ Mapper.hash(self.channelType) ^ Mapper.hash(self.transmitterId) ^ Mapper.hash(self.favourite) ^ Mapper.hash(self.online) ^ Mapper.hash(self.video1) ^ Mapper.hash(self.video1Head) ^ Mapper.hash(self.video2) ^ Mapper.hash(self.video2Head) ^ Mapper.hash(self.audio) ^ Mapper.hash(self.usb) ^ Mapper.hash(self.usb1) ^ Mapper.hash(self.serial) ^ Mapper.hash(self.audio1) ^ Mapper.hash(self.audio2) ^ Mapper.hash(self.sensitive) ^ Mapper.hash(self.viewButton) ^ Mapper.hash(self.sharedButton) ^ Mapper.hash(self.controlButton) ^ Mapper.hash(self.exclusiveButton);
  @override bool equals(p3.Channel self, p3.Channel other) => Mapper.isEqual(self.channelId, other.channelId) && Mapper.isEqual(self.name, other.name) && Mapper.isEqual(self.description, other.description) && Mapper.isEqual(self.location, other.location) && Mapper.isEqual(self.channelType, other.channelType) && Mapper.isEqual(self.transmitterId, other.transmitterId) && Mapper.isEqual(self.favourite, other.favourite) && Mapper.isEqual(self.online, other.online) && Mapper.isEqual(self.video1, other.video1) && Mapper.isEqual(self.video1Head, other.video1Head) && Mapper.isEqual(self.video2, other.video2) && Mapper.isEqual(self.video2Head, other.video2Head) && Mapper.isEqual(self.audio, other.audio) && Mapper.isEqual(self.usb, other.usb) && Mapper.isEqual(self.usb1, other.usb1) && Mapper.isEqual(self.serial, other.serial) && Mapper.isEqual(self.audio1, other.audio1) && Mapper.isEqual(self.audio2, other.audio2) && Mapper.isEqual(self.sensitive, other.sensitive) && Mapper.isEqual(self.viewButton, other.viewButton) && Mapper.isEqual(self.sharedButton, other.sharedButton) && Mapper.isEqual(self.controlButton, other.controlButton) && Mapper.isEqual(self.exclusiveButton, other.exclusiveButton);

  @override Function get typeFactory => (f) => f<p3.Channel>();
}

mixin ChannelMappable implements MappableMixin {
  String toJson() => Mapper.toJson(this as p3.Channel);
  Map<String, dynamic> toMap() => Mapper.toMap(this as p3.Channel);
  ChannelCopyWith<p3.Channel> get copyWith => _ChannelCopyWithImpl(this as p3.Channel, $identity, $identity);
  @override String toString() => Mapper.asString(this);
  @override bool operator ==(Object other) => identical(this, other) || (runtimeType == other.runtimeType && Mapper.isEqual(this, other));
  @override int get hashCode => Mapper.hash(this);
}

extension ChannelObjectCopy<$R> on ObjectCopyWith<$R, p3.Channel, p3.Channel> {
  ChannelCopyWith<$R> get asChannel => base.as((v, t, t2) => _ChannelCopyWithImpl(v, t, t2));
}

abstract class ChannelCopyWith<$R> implements ObjectCopyWith<$R, p3.Channel, p3.Channel> {
  ChannelCopyWith<$R2> _chain<$R2>(Then<p3.Channel, p3.Channel> t, Then<p3.Channel, $R2> t2);
